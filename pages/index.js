    ...
    <div className="container mx-auto p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="bg-white shadow-md rounded-lg p-6 text-center">
          ...
          <Link href="/courses">
            <span className="bg-blue-500 text-white p-2 rounded">View Courses</span>
          </Link>
        </div>
        <div className="bg-white shadow-md rounded-lg p-6 text-center">
          <h2 className="text-2xl font-bold mb-4">About Us</h2>
          <span className="mb-4">Learn more about our mission and values.</span>
          <Link href="/about">
            <span className="bg-blue-500 text-white p-2 rounded">About Us</span>
          </Link>
        </div>
        <div className="bg-white shadow-md rounded-lg p-6 text-center">
          ...
          <Link href="/contact">
            <span className="bg-blue-500 text-white p-2 rounded">Contact Us</span>
          </Link>
        </div>
      </div>
    </div>
